...
- (void)fk_animateOfJitter
{
    ...
    keyAnimaion.values = @[@(-20 / 180.0 * M_PI), @(0 /180.0 * M_PI), @(20 /180.0 * M_PI),@(0/ 180.0 * M_PI)];//度数转弧度
    keyAnimaion.removedOnCompletion = NO;
    keyAnimaion.fillMode = kCAFillModeForwards;
    keyAnimaion.duration = 0.1;
    keyAnimaion.repeatCount = 5;
    [self.layer addAnimation:keyAnimaion forKey:@"animal"];
}
...
{
    UIView *line = [UIView fk_lineWithFrame:frame];
